...
#plt.ylim(1e13, 1e16)
#plt.xlim(1e-1, 1e1)
plt.xlabel(r'$v_0\ \left[m/s\right]$')
plt.ylabel(r'Capture Volume $[AU^3]$ at $\sigma_0 = \pi R_{max}^2\ [m^2]$')
plt.scatter(v_init, cubic_meters_to_cubic_au(captV))
plt.show()
