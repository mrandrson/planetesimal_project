...
dat = pd.read_csv(os.listdir('.')[index])
'''
dat = pd.read_csv('v2b18simulation.csv')
...
ax.set_xlim(-4e16, 4e16)
ax.set_ylim(-4e16, 4e16)
ax.set_xlabel("x [m]")
ax.set_ylabel("y [m]")
ax.set_title("Planetesimal Motion Over Time")
