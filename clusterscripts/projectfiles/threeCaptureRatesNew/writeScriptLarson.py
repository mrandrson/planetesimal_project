...
for i in range(0, 79):
    for j in range(0, 10):
        writeScript(bvec[i], bvec[i+1], vvec[j], 1.349*10.0**4, i, j, 1, 10)
        os.system('sbatch submit.sh')

for i in range(0, 79):
    for j in range(0, 10):
         writeScript(bvec[i], bvec[i+1],  vvec[j], 1.349*10.0**5, i, j, 2, 10)
         os.system('sbatch submit.sh')

for i in range(0, 79):
    for j in range(0, 10):
         writeScript(bvec[i], bvec[i+1],  vvec[j], 1.349*10.0**6, i, j, 3, 10)
         os.system('sbatch submit.sh')
